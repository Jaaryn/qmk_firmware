...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_ergodox_pretty(
     ...
     KC_LSPO,    KC_Z,    KC_X,    KC_C,    KC_V,   KC_B, _______,     _______,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSPC,\
      KC_ESC, KC_CLCK, _______, KC_RGUI, KC_LALT,                                        _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,\
                                                 _______, _______,     _______, KC_CAPS,                                             \
                                                          _______,     _______,                                                      \
                                          KC_SPC,  LOWER, _______,     _______,   RAISE, FUNC                                        \
  ),

  [_DVORAK] = LAYOUT_ergodox_pretty(
      KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,   KC_5, _______,     _______,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_DEL,\
      KC_TAB, KC_SLSH, KC_COMM,  KC_DOT,    KC_P,   KC_Y, _______,     _______,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L, KC_BSPC,\
     KC_RCTL,    KC_A,    KC_O,    KC_E,    KC_U,   KC_I,                          KC_D,    KC_H,    KC_T,    KC_N,    KC_S,  KC_ENT,\
     KC_LSPO, KC_SCLN,    KC_Q,    KC_J,    KC_K,   KC_X, _______,     _______,    KC_B,    KC_M,    KC_W,    KC_V,    KC_Z, KC_RSPC,\
      KC_ESC, KC_CLCK, _______, KC_RGUI, KC_LALT,                                        _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,\
                                                    PING, KC_CCCV,     _______, KC_CAPS,                                             \
                                                          _______,     _______,                                                      \
                                          KC_SPC,  LOWER, _______,     _______,   RAISE, NAV                                         \
  ),
  ...
  [_RAISE] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______, _______, _______,     _______, _______, WIN_LFT, WIN_CLS, WIN_NEW, WIN_RHT, _______,\
    _______, _______, _______, _______, _______,                                         _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MNXT,\
                                                 _______, _______,     _______, _______,                                             \
                                                          _______,     _______,                                                      \
                                        _______, _______, _______,     _______, _______, _______                                     \
  ),
